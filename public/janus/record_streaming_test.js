...
function startRecording() {
        Janus.log("Start Recording Selected video id #" + selectedStream);
        if(selectedStream === undefined || selectedStream === null) {
                bootbox.alert("Select a stream from the list");
                return;
        }
        var body = {
        		...
        		//"video" : "/home/valerio",//"<enable video recording, and use this base path/filename; optional>",
        		//"data" :  "/home/valerio",//"<enable data recording, and use this base path/filename; optional>",
        		"audio" : "false", //|false; whether or not audio should be recorded>,
...
function stopRecording() {
	...
	Janus.log("Stop Recording Selected video id #" + selectedStream);
        if(selectedStream === undefined || selectedStream === null) {
                bootbox.alert("Select a stream from the list");
                return;
        }
